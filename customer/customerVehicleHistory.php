...
.mec1{
	...
	/*border:1px solid #000;*/
		...
		<form class="myform" action="customerVehicleHistory.php" method="POST">
			<center><label><b><h2>Car History</h2></b></label></center>
			<label><b>Select Vechile:</b></label><br>
						<select name="plateNum"   id="car" class="inputvalues"	required>
								<option></option>
							<?php
								$query="SELECT * FROM vehicles INNER JOIN usertb ON vehicles.ownerID = usertb.UserID WHERE usertb.UserID = '$userid' ";
			...
			$(document).ready(function(){
				$("#car").change(function(){
					 ...
					 alert(selectValue);
					    ...
					    $.ajax({
				 			url: '../admin/vehicleHistory.php?plateNo='+selectValue,
